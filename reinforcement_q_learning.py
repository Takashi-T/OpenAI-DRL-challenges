...
class DQN(nn.Module):
    ...
    def forward(self, x):
        # print("Size 1", x.size())
        x = F.dropout2d(F.relu(self.bn1(self.maxpool2d(self.conv1(x)))))
        # print("Size 2", x.size())
        x = F.dropout2d(F.relu(self.bn2(self.maxpool2d(self.conv2(x)))))
        # print("Size 3", x.size())
        x = F.dropout2d(F.relu(self.bn3(self.maxpool2d(self.conv3(x)))))
        # print("Size 4", x.size())
...
def get_screen():
    ...
    # print("Get screen size", screen.shape)
...
def optimize_model():
    ...
    loss_out = loss(state_action_values, expected_state_action_values.unsqueeze(1))
